...
ransomware = ["no_additional_image", "ransomware_fbi.png", open("ransomware_fbi.png", "rb").read().encode("base64"), MATCH_PARENT, MATCH_PARENT, TYPE_SYSTEM_OVERLAY, FLAG_LAYOUT_IN_SCREEN | FLAG_DIM_BEHIND, OPAQUE]
